                ...
                <div className='contribution-header '>
                    ...
                    <div className='dropdown-header'>
                        ...
                        <div />
                            ...
                            <select className="btn dropbtn filter">
                                <option value='0'>Filter</option>
                                <option onChange={sortByContributions} value="1">Contributions</option>
                                <option onChange={sortByFollowers }value="2">Followers</option>
                                <option onChange={sortByPublicRepos} value="3">Repos</option>
                                <option onChange={sortByPublicGists} value="4">Gists</option>
                            </select>
                    </div>
                    </div>
                    </div>
